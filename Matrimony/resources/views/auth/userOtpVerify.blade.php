...
@section('title') OTP Verify @endsection
              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                    <div class="d-flex align-items-center mb-3 pb-1">
                        ...
                        <span class="h1 fw-bold mb-0">OTP Verify</span>
                      </div>
                      <br>
                    ...
                    @if ($message = Session::get('error'))
                        <div class="alert alert-danger alert-dismissible loginErrorMessageMain" role="alert" style="text-align: center;">
                            <div>
                            <div class="alert-title" style="color:rgb(62, 42, 42);">
                    ...
                    @endif
                    {!! Form::open(['url' => route('verifyOtp'), 'method' => 'post', 'class' => '', 'autocomplete' => 'off', 'id' => 'otpVerifyForm']) !!}
                    {{csrf_field()}}
                    {!! Form::hidden('token', $token) !!}
                        <div class="formWrapper__formWrap">
                        <div class="form-group focused">
                            {!! Form::label('otp_code', 'Enter your 6 digit OTP', ['class' => 'form-label']) !!}
                            {!! Form::text('otp_code', null, ['class' => 'form-control formOtpInput', 'id'=> 'dealer', 'autocomplete' => 'off', 'maxlength'=>6]) !!}
                            @if ($errors->has('otp_code'))
                                <div class="text-danger text-danger--space login-error-message-otp_code">
                                    <p>{{ $errors->first('otp_code') }}</p>
                                </div>
                            @endif
                        </div>
                        <br>
                    ...
                    <a href="{{ route('resendOtp', ['id' => $token]) }}" class="mt-3 resendOtpSubmit" type="submit">Resend OTP?</a>
