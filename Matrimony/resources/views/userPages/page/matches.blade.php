...
<main class="main">
    <div class="container mt-4 mb-5">
        <div class="row">
            <div class="col-md-3">
            <div style="display: flex; align-items: center; gap: 10px;" class="mt-3">
    <a href="" onclick="history.back()">
        <i class="bi bi-arrow-left" style="font-size: 1.5rem; color: black;"></i>
    </a>
    <h3 style="color: #7A0A08; font-size: 24px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin: 0;">
        Matches
    </h3>
</div>
   ...
   <nav class="sidebar card py-2 mt-4">
    <ul class="nav flex-column" id="nav_accordion">
        <!-- Profile yet to be viewed -->
        <li class="nav-item has-submenu">
            <a class="nav-link" href="#">Profile yet to be viewed</a>
            <ul class="submenu">
                <li>
                    <input type="hidden" name="duration" id="duration" value="">
                    <a class="submenu-link" id="1" href="javascript:void(0);" onclick="durationcalc(this.id)">Within a week</a>
                </li>
                <li>
                    <a class="submenu-link" id="2" href="javascript:void(0);" onclick="durationcalc(this.id)">Within a month</a>
                </li>
                <li>
                    <a class="submenu-link" id="3" href="javascript:void(0);" onclick="durationcalc(this.id)">Within a year</a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item has-submenu">
            ...
            <ul class="submenu">
                ...
                <li><a class="submenu-link" href="javascript:void(0);" id="4" onclick="age_select(21,22)">Age 21 to Age 22</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="5" onclick="age_select(22,23)">Age 22 to Age 23</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="6" onclick="age_select(23,25)">Age 23 to Age 25</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="7" onclick="age_select(25,27)">Age 25 to Age 27</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="8" onclick="age_select(27,30)">Age 27 to Age 30</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="9" onclick="age_select(30,100)">Above Age 30</a></li>
            </ul>
        </li>
        ...
        <li class="nav-item has-submenu">
            ...
            <ul class="submenu">
                ...
                <li><a class="submenu-link" href="javascript:void(0);" id="11" onclick="height_select(16,1)">Upto 4.5ft</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="12" onclick="height_select(21,16)">4.5ft to 5ft</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="13" onclick="height_select(26,21)">5ft to 5.5ft</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="14" onclick="height_select(31,26)">5.5ft to 6ft</a></li>
                <li><a class="submenu-link" href="javascript:void(0);" id="15" onclick="height_select(31,100)">Above 6ft</a></li>
            </ul>
        </li>
        ...
        <!-- <li class="nav-item has-submenu">
            ...
            <ul class="submenu">
                ...
                <li><a class="submenu-link" href="javascript:void(0);" id="1" onclick="photo_select(this.id)">With photos</a></li>
            </ul>
        </li> -->
    </ul>
</nav>
    ...
    @else
        <div class="profile-container d-inline-block position-relative" >
            ...
            <img src="{{ asset('/images/user_image.png') }}" class="rounded-circle" width="150" height="150" alt="Default Image">
            <a href="#" data-bs-toggle="modal" data-bs-target="#iconModal{{ $i }}" class="lock-icon position-absolute bottom-0 rounded-circle" style="left: 110px;top:90px;">
    ...
    <div class="d-flex justify-content-start mb-2">
        <span class="fw-bold" style=" padding-bottom: 3px;">Age & Height:</span>
        <span class='ms-2' style="color: black;">
            {{ $age ? $age : 'Not Available' }} & 
            {{ $user->height_name ? $user->height_name : 'Not Available' }}
        </span>
    </div>
    <div class="d-flex justify-content-start mb-2">
        <span class="fw-bold" style=" padding-bottom: 3px;">Location:</span>
        <span class='ms-2' style="color: black;">{{ $user->address ?? 'Not Available' }}</span>
    </div>
    <div class="d-flex justify-content-start mb-2">
        <span class="fw-bold" style=" padding-bottom: 3px;">Profession:</span>
        <span class='ms-2' style="color: black;">{{ $user->occuption ?? 'Not Available' }}</span>
    </div>
    <div class="d-flex justify-content-start mb-2">
        <span class="fw-bold" style=" padding-bottom: 3px;">Company:</span>
        <span class='ms-2' style="color: black;">{{ $user->company_name ?? 'Not Available' }}</span>
    </div>
</div>
                    ...
                    <div class="col-md-12 mb-4 profile-card match-card" data-gender="bride">
                        <div class="wrapper-max" style="border:3px solid #e5e5e5;">
                            <div class="card">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-8 justify-content-center pt-3 ms-2 position-relative">
                                        ...
                                        @else
                                            ...
                                            <!-- <div class="position-absolute bottom-0 bg-white rounded-circle p-2" style="left: 100px;top:90px;"> -->
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#iconModalFeatured{{ $i }}" class="position-absolute bottom-0 bg-white rounded-circle" style="left: 85px; top: 75px;">
                                                    <i class="bi bi-person-fill-lock fs-4 text-dark"></i>
                                                </a>
                                            <!-- </div> -->
                                        @endif
                                ...
                                <div class="modal fade" id="iconModalFeatured{{ $i }}" tabindex="-1" aria-labelledby="iconModalLabel{{ $i }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <input type="hidden" name="profile_ids" id="profiles{{ $i }}" value="{{ $user->id }}">
                                            <input type="hidden" name="names" id="name_s{{ $i }}" value="{{ $user->name }}">
                                            <input type="hidden" name="user_ids" id="users{{ $i }}" value="{{ $user->user_id }}">
                                            ...
                                            <div class="modal-footer justify-content-center" style="border-top: none;">
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-success px-4" id="profile_view{{ $i }}" onclick="featuredprofilerequest({{ $i }})">
                                                        <i class="bi bi-send"></i> Send Request
                                                    </button>
...
<script>
    ...
    function featuredprofilerequest(index) {
        let profileId = document.getElementById(`profiles${index}`).value;
        let userId = document.getElementById(`users${index}`).value;
        let name = document.getElementById(`name_s${index}`).value;
...
<script>
    function search_profiles(page = 1) {
        ...
        if (duration != "" || (height1 != "" && height != "") || photo != "" || (age_val != "" && age_val1 != "")) {
            $.ajax({
                url: "{{ route('show_matches_filter') }}?page=" + page, 
                method: "POST",
                data: ({
                    duration: duration,
                    height1: height1,
