        ...
        <div class="col-12">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title">Profile Request Details</h3>
            </div>
      ...
      @foreach ($MemberActivityLog as $member)
        ...
        <tr>
            <td>{{$loop->iteration}}</td>
             <td> <a href="#" class='fetchdetails' data-id="{{$member->member_id}}"
             data-type='member'>{{$member->member_id}}
</a></td>


             <td><a href="#" class='fetchdetails' data-id='{{$member->profile_id}}'
             data-type='profile'>{{$member->profile_id}}</a></td>
