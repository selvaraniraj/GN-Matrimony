               ...
               'autocomplete' => 'off', 'id' => 'hobbyInfoAddForm']) !!}
                    ...
                    {!! Form::hidden('member_id', $member->id) !!}
                        <div class="row gy-4 px-4">
                            <h2 class="pt-2">Hobbies & Interests</h2>
                            <div class="row gy-2">
                                <div class="col-md-">
                                    <h4>
                        ...
                        <div class="row gy-4 p-3">
                            <div class="col-md-3 ms-4  text-start">
                                <div class="button-container">
                                    <button class="btn" id="previousBtnHobby"> Previous</button>
                                </div>
                            </div>
                            <div class="col-md-3 ms-4  text-start">
                                <div class="button-container">
                                    <button class="btn" id="nextBtnHobby">Next</button>
                                </div>
                            </div>
                            <div class="col-md-3 ms-4  text-start">
                                <div class="button-container">
                                    <button class="btn" id="skipBtnHobby"> Skip</button>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
