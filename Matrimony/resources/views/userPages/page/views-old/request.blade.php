                  ...
                  <a href="{{ route('app.v2.favoritespage') }}"> <button class="btn btn-danger ms-4"> <i
                    ...
                    <i class="fas fa-comments"></i>Photo Request
                              ...
                              <button class="btn btn-danger" style="font-size:20px;"><i
                                                                  class="fas fa-comments"></i>Request for My Contact</button>
                                                            </div>
                              </div>
...
<input type="hidden" name="id" id="profile_id{{ $index }}" value="{{ $member->id }}">
                                          ...
                                          <div class="wrapper-max" style="border:3px solid #e5e5e5;">
                                                <div class="card">
                                                      ...
                                                      <div class="row">
                                                            ...
                                                            <a href="{{ route('app.v2.popupView_page', ['id' => base64_encode( $log->id)]) }}" target="_blank">{{ $log->profile_id }} || <span>Profile
    ...
    @if($logConditions[$index] ?? false)
        <label class="mobile" style="color:green;" id="{{ $index }}flag1">Mobile Number sent!</label>
    @else
        <div class="row">
