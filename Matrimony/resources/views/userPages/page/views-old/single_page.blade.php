            ...
            <i class="bi bi-arrow-left" style="font-size: 1.5rem;color:black;"></i>
                ...
                <div class="row ms-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-4">
                                <h4 class="icon-heading" style="display: flex;align-items: center;  gap: 10px; "> Basic
                                    Information</h4>
                            </div>
    ...
    <div class="col-md-6 text-start">
        <fieldset>
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    <tr>
                        <td><textarea name="rasi_1" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_1 }}</textarea></td>
                        <td><textarea name="rasi_2" class="form-control" rows="1" style="resize: none;" disabled> {{ $horoscopeDetail -> rasi_2 }}</textarea></td>
                        <td><textarea name="rasi_3" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_3 }}</textarea></td>
                        <td><textarea name="rasi_4" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_4 }}</textarea></td>
                    </tr>
                    <tr>
                        <td><textarea name="rasi_5" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_5 }}</textarea></td>
                        <td colspan="2" rowspan="2" class="text-center align-middle">Rasi</td>
                        <td><textarea name="rasi_6" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_6 }}</textarea></td>
                    </tr>
                    <tr>
                        <td><textarea name="rasi_7" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_7 }}</textarea></td>
                        <td><textarea name="rasi_8" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_8 }}</textarea></td>
                    </tr>
                    <tr>
                        <td><textarea name="rasi_9" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_9 }}</textarea></td>
                        <td><textarea name="rasi_10" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_10 }}</textarea></td>
                        <td><textarea name="rasi_11" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_11 }}</textarea></td>
                        <td><textarea name="rasi_12" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> rasi_12 }}</textarea></td>
                    </tr>
                </tbody>
            </table>
        </fieldset>
    ...
    <div class="col-md-6">
        <fieldset>
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    <tr>
                        <td><textarea name="Navamsam_1" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_1 }}</textarea></td>
                        <td><textarea name="Navamsam_2" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_2 }}</textarea></td>
                        <td><textarea name="Navamsam_3" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_3 }}</textarea></td>
                        <td><textarea name="Navamsam_4" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_4 }}</textarea></td>
                    </tr>
                    <tr>
                        <td><textarea name="Navamsam_5" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_5 }}</textarea></td>
                        <td colspan="2" rowspan="2" class="text-center align-middle">Navamsam</td>
                        <td><textarea name="Navamsam_6" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_6 }}</textarea></td>
                    </tr>
                    <tr>
                        <td><textarea name="Navamsam_7" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_7 }}</textarea></td>
                        <td><textarea name="Navamsam_8" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_8 }}</textarea></td>
                    </tr>
                    <tr>
                        <td><textarea name="Navamsam_9" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_9 }}</textarea></td>
                        <td><textarea name="Navamsam_10" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_10 }}</textarea></td>
                        <td><textarea name="Navamsam_11" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_11 }}</textarea></td>
                        <td><textarea name="Navamsam_12" class="form-control" rows="1" style="resize: none;" disabled>{{ $horoscopeDetail -> Navamsam_12 }}</textarea></td>
                    </tr>
                </tbody>
            </table>
        </fieldset>
                                ...
                                <div class="col-md-6">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-4">
                                            @php
    $addionalheight = ($memberAddionalDetail->height_name && $memberAddionalDetail->height_name !== 'Select') 
                ? $memberAddionalDetail->height_name 
                : 'Not specified';
@endphp
                            ...
                            <div class="row gy-4 mb-2">
                                <div class="col-md-6">
                                    <div class="row gy-4">
                                        ...
                                        @php
    $addionalweight = ($memberAddionalDetail->weight_name && $memberAddionalDetail->weight_name !== 'Select') 
                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-4">
                                                <input class="without-border icon-heading not-specified"
                                                    style="display: flex;align-items: center;gap: 10px; " type="text"
                                                    id="age" name="age"
                                                    value="{{ $memberAddionalDetail->disablitiy == 1 ? 'Normal' : ($memberAddionalDetail->disablitiy == 2 ? 'Challenged' : 'Not specified') }}"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-8">
                                            <input class="without-border icon-heading not-specified"
                                                style="display: flex;align-items: center;gap: 10px; " type="text"
                                                id="age" name="age"
                                                value="{{ $memberAddionalDetail->eating_habit == 1 ? 'Vegetarian' : ($memberAddionalDetail->eating_habit == 2 ? 'Non-Vegetarian' : 'Not specified') }}"
                                                disabled>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-4">
                                                <input class="without-border icon-heading not-specified"
                                                    style="display: flex;align-items: center;gap: 10px; " type="text"
                                                    id="age" name="age" value="{{ $memberAddionalDetail->drinking_habit == 1 ? 'No' : 
    ($memberAddionalDetail->drinking_habit == 2 ? 'Occasionally' : 
    ($memberAddionalDetail->drinking_habit == 3 ? 'Yes' : 'Not specified')) }}
" disabled>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-8">
                                            <input class="without-border icon-heading not-specified"
                                                style="display: flex;align-items: center;gap: 10px; " type="text"
                                                id="age" name="age" value="{{$memberAddionalDetail->smoking_habit == 1 ? 'No' : 
    ($memberAddionalDetail->smoking_habit == 2 ? 'Occasionally' : 
    ($memberAddionalDetail->smoking_habit == 3 ? 'Yes' : 'Not specified')) }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-4">
                                                <input class="without-border icon-heading not-specified"
                                                    style="display: flex;align-items: center;gap: 10px; " type="text"
                                                    id="age" name="age" value="{{ $memberAddionalDetail->about_you ?? 'Not specified'}}"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="without-border" type="text" id="age" name="age"
                                                        value="{{ $hobbyDetail->music. '' .$hobbyDetail->othermusic }}"
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row gy-4 mb-2">
                                    <div class="col-md-6">
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-4">
                                                <input class="without-border" type="text" id="age" name="age"
                                                    value="{{ $hobbyDetail->sports.'' .$hobbyDetail->othersports }}"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row gy-4 mb-2">
                                    <div class="col-md-6">
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-4">
                                            <input class="without-border" type="text" id="age" name="age"
       value="{{ ($partnerDetail->age > 0 && $partnerDetail->age_from > 0) ? $partnerDetail->age . ' to ' . $partnerDetail->age_from : 'Not specified' }}"
       disabled>
      ...
      <div class="modal-body">
        <div class="content-text">
          <div id="form_container">
            ...
            <div class="row gy-3">
              <h2 class="mb-3">Hobbies & Interests</h2>
              ...
              <div class="col-md-12">
                @php $music = isset($hobbyDetail) && $hobbyDetail->music ? explode(',', $hobbyDetail->music) : []; @endphp
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" name="music[]" value="Indian/Classical_music" {{ in_array('Indian/Classical_music', $music) ? 'checked' : '' }}>
                  <label class="form-check-label">Indian / Classical music</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" name="music[]" value="Melody_songs" {{ in_array('Melody_songs', $music) ? 'checked' : '' }}>
                  <label class="form-check-label">Melody songs</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" name="music[]" value="Western_music" {{ in_array('Western_music', $music) ? 'checked' : '' }}>
                  <label class="form-check-label">Western music</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" id="other_music" name="music[]" value="Others" {{ in_array('Others', $music) ? 'checked' : '' }} onclick="show_othermusic(this);">
                  <label class="form-check-label">Others</label>
                </div>
                <div id="music_text" class="mt-2" style="{{ in_array('Others', $music) ? 'display:block;' : 'display:none;' }}">
                  <input type="text" class="form-control" name="other_music" placeholder="Others..." value="{{ isset($hobbyDetail) && $hobbyDetail->othermusic ? $hobbyDetail->othermusic : '' }}">
                </div>
              </div>

              <div class="col-md-12 mt-4">
                <h4>Sports/Fitness you love?</h4>
              </div>

              <div class="col-md-12">
                @php $sports = isset($hobbyDetail) && $hobbyDetail->sports ? explode(',', $hobbyDetail->sports) : []; @endphp
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" name="sports_hobbies[]" value="Cricket" {{ in_array('Cricket', $sports) ? 'checked' : '' }}>
                  <label class="form-check-label">Cricket</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" name="sports_hobbies[]" value="Carrom" {{ in_array('Carrom', $sports) ? 'checked' : '' }}>
                  <label class="form-check-label">Carrom</label>
                </div>
                <!-- Add more sports options as needed -->
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" name="sports_hobbies[]" value="Others" id="other_sports" onclick="show_othersports(this);" {{ in_array('Others', $sports) ? 'checked' : '' }}>
                  <label class="form-check-label">Others</label>
                </div>
                <div id="sports_text" class="mt-2" style="{{ in_array('Others', $sports) ? 'display:block;' : 'display:none;' }}">
                  <input type="text" class="form-control" name="other_sports" placeholder="Others..." value="{{ isset($hobbyDetail) && $hobbyDetail->othersports ? $hobbyDetail->othersports : '' }}">
                </div>
              </div>
                        ...
                        <div class="row gy-4">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <option value="0">Select</option>
                                            @for ($i = 21; $i <= 35; $i++)
                                             <option value="{{ $i }}"   {{ isset($partnerDetail) &&  $partnerDetail->age == $i ? 'selected' : '' }}>{{ $i }}</option>
                                             @endfor
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control" name="age_from" id="age_from">
                                            <option value="0">Select</option>
                                            @for ($i = 21; $i <= 35; $i++)
                                            <option value="{{ $i }}" {{isset($partnerDetail) && $partnerDetail->age_from == $i ? 'selected' : '' }}>{{ $i }}</option>
                                             @endfor
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control" name="height_to" id="height_to">
                                           @foreach($height as $id => $name)
                                           <option value="{{ $id }}" {{isset($partnerDetail) && $partnerDetail->height_id  == $id ? 'selected' : '' }}>{{ $name }}</option>
                                           @endforeach
                                        </select>
                                        @error('height_id')
                                        <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control" name="height_from" id="height_from">
                                            @foreach($height as $id => $name)
                                            <option value="{{ $id }}" {{isset($partnerDetail) && $partnerDetail->height_id_from   == $id ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-7">
                                        <label class="px-2"> <input type="radio" name="per_religion"
                                                value="Hindu" {{isset($partnerDetail) && $partnerDetail->religion == 'Hindu' ? 'checked' : '' }}>Hindu</label>
                                        <label class="px-2"><input type="radio" name="per_religion"
                                                value="Christian" {{  isset($partnerDetail) && $partnerDetail->religion == 'Christian' ? 'checked' : '' }}>Christian</label>
                                        <br>
                                ...
                                <div class="row gy-4 pt-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="px-2"> <input type="radio" name="par_mother_tongue"
                                                value="Tamil"  {{isset($partnerDetail) && $partnerDetail->mother_tongue == 'Tamil' ? 'checked' : '' }}>Tamil</label>
                                        <label class="px-2"><input type="radio" name="par_mother_tongue"
                                                value="Malayalam"  {{isset($partnerDetail) && $partnerDetail->mother_tongue == 'Malayalam' ? 'checked' : '' }}>Malayalam</label>
                                        <label class="px-2"><input type="radio" name="par_mother_tongue"
                                                value="Telugu"  {{isset($partnerDetail) && $partnerDetail->mother_tongue == 'Telugu' ? 'checked' : '' }}>Telugu</label>
                                        <br>
                                        @error('mother_tongue')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        <span class="error" id="mother_tongue_error">Please select Monter Tongue.</span>
                                    </div>
                                </div>
                                <div class="row gy-4 pt-3">
                                    <div class="col-md-4  text-start">
                                    ...
                                    <div class="col-md-6">
                                        <label class="px-2"> <input type="radio" name="par_caste"
                                                value="Nadar"  {{isset($partnerDetail) && $partnerDetail->caste == 'Nadar' ? 'checked' : '' }}>Nadar</label>
                                        <br>
                                ...
                                <div class="row gy-4 pt-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="px-2"> <input type="radio" name="par_dhosam" value="No" {{isset($partnerDetail) && $partnerDetail->dosam == 'No' ? 'checked' : '' }}>No</label>
                                        <label class="px-2"> <input type="radio" name="par_dhosam"
                                                value="Yes" {{isset($partnerDetail) && $partnerDetail->dosam == 'Yes' ? 'checked' : '' }}>Yes</label>
                                        <label class="px-2"> <input type="radio" name="par_dhosam"
                                                value="Dont_Know" {{isset($partnerDetail) && $partnerDetail->dosam == 'Dont_Know' ? 'checked' : '' }}>Don't Know</label>
                                    </div>
                                </div>
                                <div class="row gy-4 pt-3">
                                    <div class="col-md-4  text-start">
                                    ...
                                    <div class="col-md-4">
                                        <select multiple id="multiselect1" name="par_raasi[]" placeholder="Select Raasi"
                                            ...
                                            @foreach($raasi as $id => $name)
                                            <option value="{{ $id }}" {{ isset($partnerDetail) && in_array($name, explode(',', $partnerDetail->rassi)) ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                            </option>
                                        </select>
                                        @error('raasi_id')
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-4">
                                        <select multiple id="multiselect2" name="par_star[]" placeholder="Select Star"
                                            data-search="true" data-silent-initial-value-set="true">
                                            @foreach($stars as $id => $name)
                                            <option value="{{ $id }}" {{ isset($partnerDetail) && in_array($name, explode(',', $partnerDetail->star)) ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                            </option>
                                        </select>
                                        @error('star_id')
                            ...
                            <div class="row gy-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="par_income">
                                        <option value="">Select</option>
                                        <option value="10,000-20,000" {{ isset($partnerDetail) && $partnerDetail->income == '10,000-20,000' ? 'selected' : '' }}>10,000-20,000</option>
                                        <option value="20,000-30,000" {{ isset($partnerDetail) && $partnerDetail->income == '20,000-30,000' ? 'selected' : '' }}>20,000-30,000</option>
                                        <option value="30,000-60,000" {{ isset($partnerDetail) && $partnerDetail->income == '30,000-60,000' ? 'selected' : '' }}>30,000-60,000</option>
                                        <option value="60,000-80,000" {{ isset($partnerDetail) && $partnerDetail->income == '60,000-80,000' ? 'selected' : '' }}>60,000-80,000</option>
                                        <option value="80,000-1lakh" {{ isset($partnerDetail) && $partnerDetail->income == '80,000-1lakh' ? 'selected' : '' }}>80,000-1 lakh</option>
                                        <option value="1lakh-1.5lakh" {{ isset($partnerDetail) && $partnerDetail->income == '1lakh-1.5lakh' ? 'selected' : '' }}>
                                            1 lakh-1.5lakh
                                        </option>
