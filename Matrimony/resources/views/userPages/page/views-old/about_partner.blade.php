        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-8 px-4 reservation-form-bg" data-aos="fade-up" data-aos-delay="200">
                <div id="form_container">
                    ...
                    <div class="row gy-4">
                        <h2 class="pt-2">About Partner</h2>
                        ...
                        <div class="row p-3">
                            <div class="col-md-3 ms-4  text-start">
                                <div class="button-container">
                                    <button class="btn" id="previousBtnPartner"> Previous</button>
                                </div>
                            </div>
                            <div class="col-md-3 ms-4  text-start">
                                <div class="button-container">
                                    <button class="btn" id="nextBtnPartner">Next</button>
                                </div>
                            </div>
                            <div class="col-md-3 ms-4  text-start">
                                <div class="button-container">
                                    <button class="btn" id="skipBtnPartner"> Skip</button>
                                </div>
                            </div>
                        </div>
                    </div>
