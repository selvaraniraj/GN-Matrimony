...
@section('content')
<main>
    <div class="container" style="background-color:#FFF5F5; min-height: 100vh;">
        <div class="row d-flex justify-content-center align-items-center">

        
        <h4 class="icon-heading pb-1" style="display: flex; align-items: center; justify-content: center; gap: 10px; text-align: center;"> 
    {{$user->name}} 
    ...
    <div class="col-auto text-center position-relative" style="min-height: 220px;">
        ...
        @else
            ...
            <div class="position-absolute bottom-0 rounded-circle" style="left: 80%; top: 65%;">
...
<div class="row gy-4" id="add_interest"
                                                @if(in_array($user->id, $profiles) || in_array($user->id, $unlike_profile)) 
                                                    style="display:none" 
                                                @else 
                                                    style="display:block" 
                                                @endif>
                                                ...
                                                <div class="col-md-12">
                                               <h5 class="align-items-center" style="text-align:center"> <strong>Interest:</strong></h5>
                                                    <button class="btn btn-success btn-sm px-4 py-2" onclick="add_interest_status(1,1);">
                                                    <i class="bi bi-hand-thumbs-up"></i> Yes
                                                    </button>
                                                    <button class="btn btn-danger btn-sm px-4 py-2" onclick="add_interest_status(2,1);">
                                             ...
                                             <div class="row" id="interest1"
                                                @if(in_array($user->id, $profiles)) 
                                                    style="display:block" 
                                                @else 
                                                    style="display:none" 
                                                @endif>
                                                <div class="col-md-12 d-flex flex-column align-items-center">
                                                <h5 class="align-items-center"> <strong>Interest:</strong></h5>
                                             ...
                                             <div class="row" id="not_interest1"
                                                @if(in_array($user->id, $unlike_profile)) 
                                                    style="display:block" 
                                                @else 
                                                    style="display:none" 
                                                @endif>
...
<input type="hidden" name="members_id" value="{{ $user->id }}" id="members_id1">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header text-white justify-content-center" style="border-bottom: none;">
                <h5 class="modal-title d-flex align-items-center text-white" id="iconModalLabel">
                    <i class="bi bi-shield-lock me-2"></i> Request to View Profile
                </h5>
            ...
            <div class="modal-footer justify-content-center" style="border-top: none;">
                ...
                <h5 class="modal-title d-flex align-items-center text-success fw-bold">
                     Request Sent successfully!
                </h5>
                    <!-- <span id="requestedsend" class="text-success px-4 w-100">Request Sent successfully!</span> -->
                @else
                    <button type="button" class="btn btn-success  justify-content-center px-4" id="profile_view" style="background-color:#8E0000" onclick="profilerequest()">
                ...
                <div class="row m-4 card shadow text-center" style="border:1px solid #BF8E8C; border-radius: 10px; justify-content: center;">
    <div class="col-auto">
        <h4 class="icon-heading pt-2 d-flex align-items-center justify-content-center gap-2">
            Basic Information for {{ $user->name }}
            <span style="color: green;">
                {{ $user->profile_id ? '(' . $user->profile_id . ')' : '(Profile ID not available)' }}
            </span>
        </h4>
                    ...
                    <div id="requested">
                        <div class="row">
                            <div class="col-md-12 mx-auto text-center">
                                <span class="btn btn-success text-white btn-sm fs-7 disabled">Request Sent!</span>
                            </div>
                        </div> 
                    </div>
                ...
                @else
                    ...
                    <div class="row mt-1">
                        <div class="col-md-12 mx-auto text-center" id="request" >
                            <button class="btn btn-danger text-white btn-sm fs-7" type="button" onclick="mobilenumberrequest()">Request</button>
                        </div>
                        </div>
            ...
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2" rowspan="2" class="text-center align-middle" style="color:darkred;font-size:large;font-weight:bold;">Rasi</td>
            ...
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2" rowspan="2" class="text-center align-middle" style="color:darkred;font-size:large;font-weight:bold;">Navamsam</td>
