...
<main class="main">
    <div class="container">
        <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-8 px-4 reservation-form-bg" data-aos="fade-up" data-aos-delay="200">
               ...
               'autocomplete' => 'off', 'id' => 'professionalInfoAddForm']) !!}
                    {{csrf_field()}}

                    {!! Form::hidden('member_id', $member->id) !!}
                        <div class="row gy-4">
                        <h3 style="margin-top:50px;color: #ce1212; font-size: 24px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px;">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select multiple name="education" id="education"  data-search="true" data-silent-initial-value-set="true">
                                           
                                        @foreach($education as $edu)
        <option value="{{ $edu['id'] }}" {{ isset($educationDetail) && $educationDetail->education_id == $edu['id'] ? 'selected' : '' }}>
            {{ $edu['name'] . ' - ' . $edu['department'] }}
        </option>
    @endforeach
                                        </select>
                                        <span class="error" id="education_error">Please Enter your Highest
                                        Education_Level!</span>
                                        @error('education')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-3">
                                        <select class="form-control" name="education1[]" id="education1">
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row gy-4 pt-3">
                            <div class="col-lg-12 col-md-12">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" id="college_school"
                            ...
                            <div id="indiaFields"  class="{{ !empty($educationDetail) && $educationDetail['location'] == 'India' ? 'india' : 'indiaHidden' }}">
                                ...
                                <div class="row gy-4 pt-3">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <span id="citydependent_error" class="error">Please Select Your State First!</span>
                    ...
                    @endif
                                        ...
                                        <span id="talukdependent_error" class="error">Please Select Your City First!</span>
                                ...
                                <div class="row gy-4 pt-3">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" id="pincode" name="pincode"
                                            ...
                                            <span id="pincode_error" class="error">Please Enter Your Valid Pincode!</span>
                                    </div>
                                </div>
                                <div class="row gy-4 pt-3">
                                    ...
                                    <div class="col-md-5">
                                        <textarea class="form-control" name="address" id="address" rows="5"
                                            ...
                                            <span id="address_error" class="error">Please Enter Your Valid Address!</span>
                                        </div>
                                </div>
                            </div>
    ...
    <div class="col-sm-4 col-md-3 d-flex justify-content-center">
        <div class="button-container d-flex justify-content-center align-items-center w-100">
            <button class="btn w-100" id="previousBtn">Previous</button>
        </div>
    </div>
    ...
    <div class="col-sm-4 col-md-3 d-flex justify-content-center">
        <div class="button-container d-flex justify-content-center align-items-center w-100">
            <button class="btn w-100" id="nextBtn">Next</button>
        </div>
    </div>
    ...
    <div class="col-sm-4 col-md-3 d-flex justify-content-center">
        <div class="button-container d-flex justify-content-center align-items-center w-100">
            <button class="btn w-100" id="skipBtn">Skip</button>
        </div>
    </div>
</div>
...
$('#skipBtn').on('click', function() {
    $('#professionalInfoAddForm').attr('action', "{{ route('app.professional_info_skip.member') }}").submit();
});
