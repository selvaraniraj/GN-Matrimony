    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="wrapper-max" style="border:3px solid #e5e5e5;">
                <div class="card">
                    <button class="btn btn-danger" style="font-size:20px;"><i class="fas fa-comments"></i>Request Send
                        Details</button>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8" style="padding-left:20px;" onclick="view_person(event, this)"
                                    ...
                                    <a href="{{ route('app.v2.popupView_page', ['id' => base64_encode( $log->id)]) }}"
                                        target="_blank">{{ $log->profile_id ?? 'Profile ID not available' }} ||
                                        <span>Profile
                                ...
                                <div class="col-md-7">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-4">
                                                <label class="card-text">Request Type</label>
                                            </div>
                                            <div class="col-md-8 px-4">
                                                ...
                                                {{-- Mobile Number Request (flag 2) --}}
                                                @if (in_array($pid, $mobileRequest))
                                                <span class="badge bg-primary me-2">Mobile Request Sent</span>
                                                @endif

                                                {{-- Photo Request (flag 4) --}}
                                                @if (in_array($pid, $logConditionsRequest) || in_array($pid,
                                                $upprovePhoto))
                                                <span class="badge bg-warning text-dark me-2">Photo Request Sent</span>
                                                @endif

                                                {{-- Interest Request (liked_flag = 1) --}}
                                                @if (in_array($pid, $likedProfiles))
                                                <span class="badge bg-success me-2">Interest Sent</span>
                                                @endif

                                                {{-- If nothing --}}
                                                @if (
                                                !in_array($pid, $mobileRequest) &&
                                                !in_array($pid, $logConditionsRequest) &&
                                                !in_array($pid, $upprovePhoto) &&
                                                !in_array($pid, $likedProfiles)
                                                )
                                                <span class="text-muted">No request sent</span>
                                                @endif
