...
@section('content')
<main>
    <div class="container mb-5" style="background-color:#FFF5F5; min-height: 100vh;">
      ...
      <!-- Print Header (Only shows when printing) -->
        <div class="print-header">
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <h3>{{ $user->name }}</h3>
                    <p>Profile ID: {{ $user->profile_id ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
        ...
        <h4 class="icon-heading pb-1 pt-1" style="display: flex; align-items: center; justify-content: center; gap: 10px; text-align: center;"> 
    {{$user->name}} 
    <!-- <span style="color: green;">
        {{ $user->profile_id ? '(' . $user->profile_id . ')' : '(Profile ID not available)' }}
            ...
            <div class="col-md-9 card p-4 mb-3 ">
